...
+(BOOL)holderData
{
//    if ([WastepaperBasketDefaults standardUserDefaults].user_id.length>0) {
//        return YES;
//    }else{
//        return NO;
//    }
...
+ (void)shouldTo:(id)responseObject{
...
+ (NSString *)psyche{
    ...
    NSString *userId = [WastepaperBasketDefaults at].accid;
    //: return userId;
    return userId;
}
...
//    NSString *UserNo = emptyString([WastepaperBasketDefaults standardUserDefaults].mobile);
//    return UserNo;
//}
//
//+ (NSString *)getHeaderImageUrl{
//    NSString *headImageUrl = emptyString([WastepaperBasketDefaults standardUserDefaults].head_img);
//    return headImageUrl;
//}
//+ (NSString *)getNickName{
//    NSString *headImageUrl = emptyString([WastepaperBasketDefaults standardUserDefaults].user_nickname);
//    return headImageUrl;
//}
//
//+ (void)callSevicePhoneNumber{
//    NSMutableString * string = [[ NSMutableString alloc] initWithFormat: @"tel:%@", [WastepaperBasketDefaults standardUserDefaults].serverPhoneNumber];
//    [[ UIApplication sharedApplication] openURL:[ NSURL URLWithString:string]];
//}
//+ (NSString *)setPrefixURLWithURL:(NSString *)imageurl{
//    NSString *prefixStr = [WastepaperBasketDefaults standardUserDefaults].prefixURL;
//
...
//    NSString *prefixStr = [WastepaperBasketDefaults standardUserDefaults].prefixURL;
//    NSString *suffixStr = [WastepaperBasketDefaults standardUserDefaults].thumbURL;
...
//+ (NSString *)getApikey{
//    NSString *apikey = emptyString([WastepaperBasketDefaults standardUserDefaults].apikey);
//    return apikey;
//}
//
//+ (NSString *)getApisecret{
//    NSString *apisecret = emptyString([WastepaperBasketDefaults standardUserDefaults].apisecret);
//    return apisecret;
//}
...
//        return;
//    }
//    [WastepaperBasketDefaults standardUserDefaults].compId = [dict newStringValueForKey:@"compId"];
//    [WastepaperBasketDefaults standardUserDefaults].orgId = [dict newStringValueForKey:@"orgId"];
//    [WastepaperBasketDefaults standardUserDefaults].orgName = [dict newStringValueForKey:@"orgName"];
//
//
//    [WastepaperBasketDefaults standardUserDefaults].longitude = [[dict newStringValueForKey:@"longitude"] doubleValue];
//    [WastepaperBasketDefaults standardUserDefaults].latitude  = [[dict newStringValueForKey:@"latitude"] doubleValue];
//
//    [WastepaperBasketDefaults standardUserDefaults].company_latitude = [dict newStringValueForKey:@"latitude"];
//    [WastepaperBasketDefaults standardUserDefaults].company_longitude = [dict newStringValueForKey:@"longitude"];
//
//    [WastepaperBasketDefaults standardUserDefaults].province = [dict newStringValueForKey:@"province"];
//    [WastepaperBasketDefaults standardUserDefaults].city     = [dict newStringValueForKey:@"city"];
//    [WastepaperBasketDefaults standardUserDefaults].district   = [dict newStringValueForKey:@"county"];
//    [WastepaperBasketDefaults standardUserDefaults].address   = [dict newStringValueForKey:@"address"];
//
...
//            
//            [WastepaperBasketDefaults standardUserDefaults].myName = [data newStringValueForKey:@"realName"];
//            [WastepaperBasketDefaults standardUserDefaults].myHeadImg = [data newStringValueForKey:@"headImg"];
//            [WastepaperBasketDefaults standardUserDefaults].myPosition = [data newStringValueForKey:@"position"];
//            [WastepaperBasketDefaults standardUserDefaults].myCompanyName = [data newStringValueForKey:@"compName"];
//
//        }
