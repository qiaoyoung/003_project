...
+ (instancetype)whiteImage:(NSString *)badgeValue{
    ...
    CuttingEdgeView *instance = [[CuttingEdgeView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance detailScreen:badgeValue];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self content:rect clinic:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self familyNameContext:rect date:context];
    }
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self detailScreen:badgeValue];
...
- (CGSize)cell:(NSString *)badgeValue{
...
- (CGRect)detailScreen:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self cell:badgeValue];
...
- (void)content:(CGRect)rect clinic:(CGContextRef)context{
...
- (void)familyNameContext:(CGRect)rect date:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;
