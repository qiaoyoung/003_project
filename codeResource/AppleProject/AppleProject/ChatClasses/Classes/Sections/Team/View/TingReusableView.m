...
- (void)text:(id<WithChild>)data{
    ...
    NSURL *url = [NSURL URLWithString:data.red];
    //: [self.imageView nim_setImageWithURL:url placeholderImage:data.imageNormal];
    [self.imageView title:url sumeract:data.standard];
    ...
    self.roleImageView.image = [LanguageChild beVoice:data.at];
