...
typedef void (^V2NIMSignallingJoinRoomSuccess)(V2NIMSignallingRoomInfo *result);
...
// *  同时延期创建者与房间
// *  创建者与房间内的人均可调用该接口
// *  续期后， 成员列表可能已经发生变化， 界面上可以做相应提示处理
// */
//- (void)delayRoom:(NSString *)channelId
//          success:(V2NIMSignallingDelayRoomSuccess)success
//          failure:(V2NIMFailureCallback)failure;
 ...
 */
- (void)onSyncRoomList:(NSArray<V2NIMSignallingRoomInfo *> *)channelRooms;
