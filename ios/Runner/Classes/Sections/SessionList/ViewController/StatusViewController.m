...
//: invite_you_group
Byte str_chickenData[] = {94, 16, 69, 6, 210, 190, 174, 179, 187, 174, 185, 170, 164, 190, 180, 186, 164, 172, 183, 180, 186, 181, 59};


//: team_create_helper_create_failed
Byte str_commissionName[] = {64, 32, 66, 11, 78, 128, 42, 244, 186, 107, 51, 182, 167, 163, 175, 161, 165, 180, 167, 163, 182, 167, 161, 170, 167, 174, 178, 167, 180, 161, 165, 180, 167, 163, 182, 167, 161, 168, 163, 171, 174, 167, 166, 12};


//: notification
Byte str_sizeIconName[] = {62, 12, 30, 6, 23, 35, 140, 141, 146, 135, 132, 135, 129, 127, 146, 135, 141, 140, 182};


//: 我的电脑
Byte str_cameraTitle[] = {23, 12, 59, 8, 131, 27, 16, 37, 33, 195, 204, 34, 213, 191, 34, 207, 240, 35, 191, 204, 128};


//: ic_distrub
Byte str_ambleMinName[] = {41, 10, 81, 14, 100, 180, 2, 50, 157, 216, 172, 222, 154, 63, 186, 180, 176, 181, 186, 196, 197, 195, 198, 179, 13};


//: [有人@你]
Byte str_rideData[] = {99, 12, 1, 8, 109, 142, 47, 169, 92, 231, 157, 138, 229, 187, 187, 65, 229, 190, 161, 94, 23};


//: tname
Byte str_priseName[] = {74, 5, 11, 4, 127, 121, 108, 120, 112, 177};


//: jpg
Byte str_weaponName[] = {99, 3, 36, 11, 187, 82, 159, 173, 64, 156, 103, 142, 148, 139, 201};


//: setting_privacy_camera
Byte str_interventionRecordTitle[] = {17, 22, 89, 4, 204, 190, 205, 205, 194, 199, 192, 184, 201, 203, 194, 207, 186, 188, 210, 184, 188, 186, 198, 190, 203, 186, 219};


//: activity_create_group_name_create_group
Byte str_disableTitle[] = {68, 39, 98, 4, 195, 197, 214, 203, 216, 203, 214, 219, 193, 197, 212, 199, 195, 214, 199, 193, 201, 212, 209, 215, 210, 193, 208, 195, 207, 199, 193, 197, 212, 199, 195, 214, 199, 193, 201, 212, 209, 215, 210, 59};


//: type
Byte str_lifeContent[] = {15, 4, 89, 8, 249, 100, 81, 1, 205, 210, 201, 190, 196};


//: ic_nodistrub
Byte str_accordingValue[] = {33, 12, 22, 4, 127, 121, 117, 132, 133, 122, 127, 137, 138, 136, 139, 120, 70};


//: /team/create
Byte str_listenSuraValue[] = {4, 12, 36, 7, 230, 64, 163, 83, 152, 137, 133, 145, 83, 135, 150, 137, 133, 152, 137, 152};


//: #999999
Byte str_lengthFromDateTitle[] = {75, 7, 36, 10, 174, 190, 247, 4, 227, 10, 71, 93, 93, 93, 93, 93, 93, 215};


//: ic_top
Byte str_gestureMessageValue[] = {44, 6, 36, 4, 141, 135, 131, 152, 147, 148, 235};


//: ic_topno
Byte str_vendName[] = {97, 8, 77, 6, 174, 141, 182, 176, 172, 193, 188, 189, 187, 188, 232};


//: /user/checkcreateteam
Byte str_messageNameForText[] = {85, 21, 14, 12, 16, 127, 36, 195, 119, 180, 156, 38, 61, 131, 129, 115, 128, 61, 113, 118, 115, 113, 121, 113, 128, 115, 111, 130, 115, 130, 115, 111, 123, 143};


//: contact_tag_fragment_cancel
Byte str_tingData[] = {13, 27, 4, 7, 38, 201, 106, 103, 115, 114, 120, 101, 103, 120, 99, 120, 101, 107, 99, 106, 118, 101, 107, 113, 105, 114, 120, 99, 103, 101, 114, 103, 105, 112, 78};


//: tag_activity_set
Byte str_improvementValue[] = {2, 16, 31, 11, 183, 8, 65, 31, 188, 184, 236, 147, 128, 134, 126, 128, 130, 147, 136, 149, 136, 147, 152, 126, 146, 132, 147, 93};


//: (未连接)
Byte str_postContent[] = {58, 11, 38, 5, 127, 78, 12, 194, 208, 14, 229, 196, 12, 180, 203, 79, 18};


//: warm_prompt
Byte str_gelTitle[] = {43, 11, 35, 14, 46, 1, 111, 101, 242, 11, 6, 190, 254, 183, 154, 132, 149, 144, 130, 147, 149, 146, 144, 147, 151, 178};


//: ic_create_chat
Byte str_sorryTitle[] = {61, 14, 87, 8, 97, 242, 101, 64, 192, 186, 182, 186, 201, 188, 184, 203, 188, 182, 186, 191, 184, 203, 197};


//: top_add_group
Byte str_statusNeedText[] = {31, 13, 54, 6, 8, 99, 170, 165, 166, 149, 151, 154, 154, 149, 157, 168, 165, 171, 166, 237};


//: name
Byte str_orationData[] = {63, 4, 57, 12, 42, 238, 171, 182, 127, 66, 102, 205, 167, 154, 166, 158, 248};


//: tid
Byte str_modelLinkTitle[] = {40, 3, 27, 4, 143, 132, 127, 212};


//: (同步数据)
Byte str_tingInfoName[] = {41, 14, 47, 7, 178, 162, 29, 87, 20, 191, 187, 21, 220, 212, 21, 196, 223, 21, 188, 221, 88, 32};


//: owner
Byte str_fromImageContent[] = {43, 5, 83, 12, 76, 154, 20, 107, 124, 77, 160, 41, 194, 202, 193, 184, 197, 2};


//: ic_add_fiend
Byte str_widowName[] = {64, 12, 70, 14, 90, 146, 84, 13, 68, 116, 6, 41, 240, 74, 175, 169, 165, 167, 170, 170, 165, 172, 175, 171, 180, 170, 63};


//: fragment_contact_new_scan
Byte str_lifeData[] = {17, 25, 94, 6, 88, 200, 196, 208, 191, 197, 203, 195, 204, 210, 189, 193, 205, 204, 210, 191, 193, 210, 189, 204, 195, 213, 189, 209, 193, 191, 204, 127};


//: top_notice
Byte str_providerName[] = {30, 10, 44, 10, 16, 36, 133, 14, 246, 201, 160, 155, 156, 139, 154, 155, 160, 149, 143, 145, 98};


//: ic_scan
Byte str_sizeNeedTitle[] = {41, 7, 20, 9, 56, 37, 182, 147, 140, 125, 119, 115, 135, 119, 117, 130, 31};


//: #875FFA
Byte str_tableShowSessionText[] = {46, 7, 39, 14, 119, 65, 120, 119, 168, 127, 31, 237, 22, 80, 74, 95, 94, 92, 109, 109, 104, 177};


//: retracted_message
Byte str_modelProgressValue[] = {30, 17, 10, 14, 108, 231, 63, 81, 97, 187, 191, 38, 110, 229, 124, 111, 126, 124, 107, 109, 126, 111, 110, 105, 119, 111, 125, 125, 107, 113, 111, 210};


//: please_contact_your_administrator
Byte str_dataSpitTitle[] = {59, 33, 55, 6, 33, 56, 167, 163, 156, 152, 170, 156, 150, 154, 166, 165, 171, 152, 154, 171, 150, 176, 166, 172, 169, 150, 152, 155, 164, 160, 165, 160, 170, 171, 169, 152, 171, 166, 169, 138};


//: no_conversation
Byte str_inputCameraData[] = {46, 15, 39, 9, 15, 169, 215, 127, 224, 149, 150, 134, 138, 150, 149, 157, 140, 153, 154, 136, 155, 144, 150, 149, 221};


//: icon_session_list_empty
Byte str_shouldLengthValue[] = {33, 23, 26, 9, 166, 8, 46, 235, 5, 131, 125, 137, 136, 121, 141, 127, 141, 141, 131, 137, 136, 121, 134, 131, 141, 142, 121, 127, 135, 138, 142, 147, 200};


//: globalsign
Byte str_cellFrameValue[] = {68, 10, 42, 13, 224, 109, 18, 77, 193, 230, 67, 115, 59, 145, 150, 153, 140, 139, 150, 157, 147, 145, 152, 28};


//: add_friend_activity_add_friend
Byte str_statusImageData[] = {26, 30, 62, 12, 90, 240, 213, 74, 225, 250, 190, 177, 159, 162, 162, 157, 164, 176, 167, 163, 172, 162, 157, 159, 161, 178, 167, 180, 167, 178, 183, 157, 159, 162, 162, 157, 164, 176, 167, 163, 172, 162, 209};


//: ic_delete
Byte str_insertWithValue[] = {31, 9, 37, 5, 41, 142, 136, 132, 137, 138, 145, 138, 153, 138, 167};


//: user_info_avtivity_upload_avatar_failed
Byte str_curiousData[] = {70, 39, 49, 9, 96, 196, 251, 246, 46, 166, 164, 150, 163, 144, 154, 159, 151, 160, 144, 146, 167, 165, 154, 167, 154, 165, 170, 144, 166, 161, 157, 160, 146, 149, 144, 146, 167, 146, 165, 146, 163, 144, 151, 146, 154, 157, 150, 149, 224};


//: activity_user_profile_chat
Byte str_messageSharedMinText[] = {46, 26, 6, 9, 70, 199, 48, 2, 56, 103, 105, 122, 111, 124, 111, 122, 127, 101, 123, 121, 107, 120, 101, 118, 120, 117, 108, 111, 114, 107, 101, 105, 110, 103, 122, 135};


//: code
Byte str_cornerPostName[] = {23, 4, 25, 12, 204, 26, 10, 62, 163, 146, 193, 195, 124, 136, 125, 126, 45};


//: 666666
Byte str_changeSumSessionName[] = {53, 6, 23, 8, 174, 64, 213, 150, 77, 77, 77, 77, 77, 77, 101};


//: (连接中)
Byte str_iconMinValue[] = {66, 11, 8, 6, 67, 223, 48, 240, 199, 166, 238, 150, 173, 236, 192, 181, 49, 247};


//: top_add_friend
Byte str_dataText[] = {66, 14, 27, 9, 151, 2, 197, 59, 9, 143, 138, 139, 122, 124, 127, 127, 122, 129, 141, 132, 128, 137, 127, 238};
...
#import "UIButton+FormationFrom.h"
...
@interface StatusViewController ()<NIMLoginManagerDelegate,StateDelegate,NIMEventSubscribeManagerDelegate,UIViewControllerPreviewingDelegate,NIMChatExtendManagerDelegate, NIMConversationManagerDelegate,MessageDelegate,NIMSystemNotificationManagerDelegate>
...
@property (nonatomic, strong) PressedView *noticeView;
...
@property (nonatomic, strong) RestoreView *policyView;
...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil{
    ...
    if (self) {
        ...
        self.autoRemoveRemoteSession = [[NameLine restoreTing] globalTable];
    }
    //: return self;
    return self;
}
...
- (void)viewDidLoad{
    ...
    self.header = [[AlterView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 0)];
    ...
    self.emptyImageView.image = [UIImage imageNamed:StringFromSharedData(str_shouldLengthValue)];
    ...
    self.emptyTipLabel.text = [MaxInformation off:StringFromSharedData(str_inputCameraData)];//@"还没有会话，在通讯录中找个人聊聊吧".ntes_localized;
    ...
    self.emptyTipLabel.textColor = [UIColor direction:StringFromSharedData(str_lengthFromDateTitle)];
    ...
    self.tableView.frame = CGRectMake(0, [UIDevice task]+140, [[UIScreen mainScreen] bounds].size.width, ([[UIScreen mainScreen] bounds].size.height - (44.0f + [UIDevice task]) - (({UIEdgeInsets i; if(@available(iOS 11.0, *)) {i = [[[UIApplication sharedApplication] delegate] window].safeAreaInsets;} else {i = UIEdgeInsetsZero;} i;}).bottom))-140);
    ...
    if(![[WastepaperBasketDefaults at].yspop isEqualToString:@"1"]){
    ...
    [FromMessage listing:^(NSDictionary * _Nonnull configDict) {
        ...
        if (configDict.allKeys.count > 0) {
            ...
            NSString *globalsign = [configDict cord:StringFromSharedData(str_cellFrameValue)];
            ...
            if (globalsign.integerValue > 0) {
                ...
                FromView *sheet = [[FromView alloc] initWithInput:self.view.bounds green:@{}];
                //: sheet.delegate = self;
                sheet.delegate = self;
                //: [sheet show];
                [sheet selectedShow];
...
- (void)input {
    ...
    AlongViewController *vc = [[AlongViewController alloc] initWithNibName:nil bundle:nil];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}

//: - (void)leftAction {
- (void)leftHandRedAction {
...
-(void)queryImageTeam{
    ...
    [FromMessage maxColor:[NSString stringWithFormat:StringFromSharedData(str_messageNameForText)] flush:nil countIn:NO alongResponseSuccess:^(id responseObject) {
        //: NSDictionary *resultDict = (NSDictionary *)responseObject;
        NSDictionary *resultDict = (NSDictionary *)responseObject;
        //: NSString *code = [resultDict newStringValueForKey:@"code"];
        NSString *code = [resultDict cord:StringFromSharedData(str_cornerPostName)];
...
- (void)primaryColor{
    ...
    UIView *topview = [[UIView alloc]initWithFrame:CGRectMake(0, [UIDevice task], [[UIScreen mainScreen] bounds].size.width, 130)];
    ...
    labtitle.text = [MaxInformation off:StringFromSharedData(str_messageSharedMinText)];
    ...
    [moreBtn addTarget:self action:@selector(bottomText) forControlEvents:UIControlEventTouchUpInside];
    //: [moreBtn setImage:[UIImage imageNamed:@"ic_scan"] forState:UIControlStateNormal];
    [moreBtn setImage:[UIImage imageNamed:StringFromSharedData(str_sizeNeedTitle)] forState:UIControlStateNormal];
    ...
    UITapGestureRecognizer *singleTap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(latitudeIn)];
    //: [box1 addGestureRecognizer:singleTap1];
    [box1 addGestureRecognizer:singleTap1];
    //: UIImageView *image1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"top_add_friend"]];
    UIImageView *image1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromSharedData(str_dataText)]];
    ...
    label12.text = [MaxInformation off:StringFromSharedData(str_statusImageData)];
    ...
    UITapGestureRecognizer *singleTap2 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(indexOn)];
    //: [box2 addGestureRecognizer:singleTap2];
    [box2 addGestureRecognizer:singleTap2];

    //: UIImageView *image2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"top_add_group"]];
    UIImageView *image2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:StringFromSharedData(str_statusNeedText)]];
    ...
    label2.text = [MaxInformation off:StringFromSharedData(str_disableTitle)];
...
//    _resqBtn.layer.cornerRadius = 30;
    ...
    [_resqBtn setImage:[UIImage imageNamed:StringFromSharedData(str_providerName)] forState:UIControlStateNormal];
    //: [_resqBtn setTitle:[NTESLanguageManager getTextWithKey:@"notification"] forState:UIControlStateNormal];
    [_resqBtn setTitle:[MaxInformation off:StringFromSharedData(str_sizeIconName)] forState:UIControlStateNormal];
    //: [_resqBtn addTarget:self action:@selector(handlerNotice) forControlEvents:UIControlEventTouchUpInside];
    [_resqBtn addTarget:self action:@selector(imageHolder) forControlEvents:UIControlEventTouchUpInside];
    //: [_resqBtn layoutButtonWithEdgeInsetsStyle:(MKButtonEdgeInsetsStyleTop) imageTitleSpace:10];
    [_resqBtn image:(MKButtonEdgeInsetsStyleTop) keep:10];
...
- (void)cleanly {
    ...
    _mesBtn.backgroundColor = [UIColor direction:StringFromSharedData(str_tableShowSessionText)];
    //: [_resqBtn setTitleColor:[UIColor colorWithHexString:@"666666"] forState:UIControlStateNormal];
    [_resqBtn setTitleColor:[UIColor direction:StringFromSharedData(str_changeSumSessionName)] forState:UIControlStateNormal];
...
- (void)to {
    ...
    _resqBtn.backgroundColor = [UIColor direction:StringFromSharedData(str_tableShowSessionText)];
    //: [_mesBtn setTitleColor:[UIColor colorWithHexString:@"666666"] forState:UIControlStateNormal];
    [_mesBtn setTitleColor:[UIColor direction:StringFromSharedData(str_changeSumSessionName)] forState:UIControlStateNormal];
...
- (void)imageHolder {
    ...
    TopViewController *vc = [[TopViewController alloc] initWithNibName:nil bundle:nil];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)find:(NIMRecentSession *)recent sum:(NSIndexPath *)indexPath{
    //: NTESSessionViewController *vc = [[NTESSessionViewController alloc] initWithSession:recent.session];
    PointBlankViewController *vc = [[PointBlankViewController alloc] initWithOf:recent.session];
    //: [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController pushViewController:vc animated:YES];
}

//: - (void)onSelectedAvatar:(NIMRecentSession *)recent
- (void)position:(NIMRecentSession *)recent
    ...
    if (recent.session.sessionType == NIMSessionTypeP2P) {
        ...
        vc = [[HideViewController alloc] initWithOn:recent.session.sessionId];
        //: [self.navigationController pushViewController:vc animated:YES];
        [self.navigationController pushViewController:vc animated:YES];
    }
}
...
- (void)extra:(NIMRecentSession *)recent along:(NSIndexPath *)indexPath
{
    ...
    [manager deleteRecentSession:recent option:option completion:^(NSError * _Nullable error) {
        ...
        if (!error) {
            ...
            self.recentSessions = [self practice:self.recentSessions];
            //: [self refresh];
            [self up];
        }
    //: }];
...
- (void)view:(NIMRecentSession *)recent
                   //: atIndexPath:(NSIndexPath *)indexPath
                   falseTextColor:(NSIndexPath *)indexPath
                         //: isTop:(BOOL)isTop
                         towardDisplay:(BOOL)isTop
{
    //: if (isTop)
    if (isTop)
    {
...
- (void)dateOrderedSeries:(NIMRecentSession *)recent alongCommentDrunkLimited:(BOOL)isDis
{
    //: CCCKitInfo *info = nil;
    TitleInfo *info = nil;
...
- (NSString *)size:(NIMRecentSession *)recent{
    ...
    if ([recent.session.sessionId isEqualToString:[[NIMSDK sharedSDK].loginManager currentAccount]]) {
        ...
        return StringFromSharedData(str_cameraTitle).language;
    }
    //: return [super nameForRecentSession:recent];
    return [super size:recent];
}
...
- (void)onLogin:(NIMLoginStep)step {
    ...
    //: ((CCCAppDelegate*)([UIApplication sharedApplication].delegate)).loginStep = step;
    ...
    switch (step) {
        ...
        case NIMLoginStepLinkFailed:
            ...
            self.navigationItem.title = StringFromSharedData(str_postContent).language;
            //: break;
            break;
        //: case NIMLoginStepLinking:
        case NIMLoginStepLinking:
            //: self.navigationItem.title = @"(连接中)".ntes_localized;
            self.navigationItem.title = StringFromSharedData(str_iconMinValue).language;
            //: break;
            break;
        ...
        case NIMLoginStepSyncing:
            ...
            self.navigationItem.title = StringFromSharedData(str_tingInfoName).language;
            //: break;
            break;
        //: default:
        default:
...
- (UISwipeActionsConfiguration *)tableView:(UITableView *)tableView trailingSwipeActionsConfigurationForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIContextualAction *deleteAction1 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self extra:recentSession along:indexPath];
        //: [tableView setEditing:NO animated:YES];
        [tableView setEditing:NO animated:YES];
    ...
    UIContextualAction *deleteAction2 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self view:recentSession falseTextColor:indexPath towardDisplay:isTop];
    //: }];
    }];
    ...
    if (recentSession.session.sessionType == NIMSessionTypeTeam) {
        ...
        info = [[Indicator reach] text:recentSession.session.sessionId byLabel:nil];
        //: NIMTeamNotifyState notifyState = [[[NIMSDK sharedSDK] teamManager] notifyStateForNewMsg:info.infoId];
        NIMTeamNotifyState notifyState = [[[NIMSDK sharedSDK] teamManager] notifyStateForNewMsg:info.infoId];
    ...
    //: } else if (recentSession.session.sessionType == NIMSessionTypeP2P) {
        ...
        info = [[Indicator reach] indoors:recentSession.session.sessionId harvest:option];
    ...
    UIContextualAction *deleteAction3 = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:nil handler:^(UIContextualAction * _Nonnull action, __kindof UIView * _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
        ...
        [self dateOrderedSeries:recentSession alongCommentDrunkLimited:isDisnodistrub];
    //: }];
    }];
...
//    //只能设置背景颜色，图片，文字
    ...
    deleteAction1.image = [UIImage imageNamed:StringFromSharedData(str_insertWithValue)];
//
    ...
    if(isTop){
        ...
        deleteAction2.image = [UIImage imageNamed:StringFromSharedData(str_vendName)];
    //: }else{
    }else{
        //: deleteAction2.image = [UIImage imageNamed:@"ic_top"];
        deleteAction2.image = [UIImage imageNamed:StringFromSharedData(str_gestureMessageValue)];
    }
    ...
    if(isDisnodistrub){
        ...
        deleteAction3.image = [UIImage imageNamed:StringFromSharedData(str_accordingValue)];
    //: }else{
    }else{
        //: deleteAction3.image = [UIImage imageNamed:@"ic_distrub"];
        deleteAction3.image = [UIImage imageNamed:StringFromSharedData(str_ambleMinName)];
    }
//    // 创建包含图片和文字的自定义视图
...
- (void)complete{
    ...
    self.header.top = [UIDevice task]+140;
...
- (NSAttributedString *)byStep:(NIMRecentSession *)recent{
    ...
    if (recent.lastMessage.messageType == NIMMessageTypeCustom)
    {
        ...
        if ([recent.lastMessage.text containsString:[MaxInformation off:StringFromSharedData(str_modelProgressValue)]]) {
            //: msg = [self lastMessageWithNoRevocationMessage:recent.lastMessage];
            msg = [self sign:recent.lastMessage];
        }
        //: NSString *text = [NTESMessageUtil messageContent:msg];
        NSString *text = [MessageStatus textCipher:msg];
        //: if (recent.session.sessionType != NIMSessionTypeP2P)
        if (recent.session.sessionType != NIMSessionTypeP2P)
        {
            //: NSString *nickName = [NTESSessionUtil showNick:msg.from inSession:msg.session];
            NSString *nickName = [ChildMark corner:msg.from placeText:msg.session];
...
- (NIMMessage *)sign:(NIMMessage *)recentMsg {
...
- (NSMutableAttributedString *)attributed:(NSAttributedString *)attributedString {
    // 匹配 [表情]
    ...
    if (attrM.length > 0) {
        ...
        NSArray<NSTextCheckingResult *> *emoticonResults = [[StatusViewController emotion] matchesInString:attrM.string options:kNilOptions range:attrM.yy_rangeOfAll];
        ...
        [emoticonResults enumerateObjectsWithOptions:NSEnumerationReverse usingBlock:^(NSTextCheckingResult * _Nonnull emo, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            //: NIMInputEmoticon *emoticon = [[AAAInputEmoticonManager sharedManager] emoticonByTag:emoString];
            LiquidEcstasyEmoticon *emoticon = [[DataOf telegram] popAt:emoString];

            //: UIImage *image = [UIImage nim_emoticonInKit:emoticon.filename];
            UIImage *image = [UIImage pickings:emoticon.filename];
...
- (void)today:(NIMRecentSession *)recent aggregation:(NSMutableAttributedString *)content
{
    //: if ([NTESSessionUtil recentSessionIsMark:recent type:NTESRecentSessionMarkTypeAt]) {
    if ([ChildMark target:recent extra:NTESRecentSessionMarkTypeAt]) {
        ...
        NSAttributedString *atTip = [[NSAttributedString alloc] initWithString:StringFromSharedData(str_rideData).language attributes:@{NSForegroundColorAttributeName:[UIColor redColor]}];
...
- (void)range:(NIMRecentSession *)recent account:(NSMutableAttributedString *)content
{
    //: if (recent.session.sessionType == NIMSessionTypeP2P) {
    if (recent.session.sessionType == NIMSessionTypeP2P) {
//        NSString *state  = [ChildMark onlineState:recent.session.sessionId detail:NO];
//        if (state.length) {
...
-(void)fileAllocationTable:(NSString *)teamID replyType:(NSString *)teamName data:(NSString *)type{
    //: NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    NSString *currentUserId = [[NIMSDK sharedSDK].loginManager currentAccount];
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"owner"] = currentUserId;
    dict[StringFromSharedData(str_fromImageContent)] = currentUserId;
    //: dict[@"type"] = type;
    dict[StringFromSharedData(str_lifeContent)] = type;
    //: dict[@"tname"] = teamName;
    dict[StringFromSharedData(str_priseName)] = teamName;
    //: dict[@"tid"] = teamID;
    dict[StringFromSharedData(str_modelLinkTitle)] = teamID;

}

//: - (void)presentMemberSelector:(ContactSelectFinishBlock) block{
- (void)existingUponSearchor:(ContactSelectFinishBlock) block{
...
- (void)containerWith {
    ...
    NSArray *modelsArray = [self carteDuJourButton];
    ...
    self.dropdownMenu = [FFDropDownMenuView new];
     ...
     self.dropdownMenu.triangleY = [UIDevice task] +30;
    ...
    self.dropdownMenu.cellClassName = @"EnableView";
...
- (NSArray *)carteDuJourButton {
    //菜单模型0
    //: NSString *add_friend = [NTESLanguageManager getTextWithKey:@"add_friend_activity_add_friend"];
    NSString *add_friend = [MaxInformation off:StringFromSharedData(str_statusImageData)];
    ...
    FFDropDownMenuModel *menuModel0 = [FFDropDownMenuModel ff_DropDownMenuModelWithMenuItemTitle:add_friend menuItemIconName:StringFromSharedData(str_widowName) menuBlock:^{
        //: NTESContactAddFriendViewController *vc = [[NTESContactAddFriendViewController alloc] initWithNibName:nil bundle:nil];
        AlongViewController *vc = [[AlongViewController alloc] initWithNibName:nil bundle:nil];
        //: [self.navigationController pushViewController:vc animated:YES];
        [self.navigationController pushViewController:vc animated:YES];
    ...
    NSString *activity = [MaxInformation off:StringFromSharedData(str_disableTitle)];
    ...
    FFDropDownMenuModel *menuModel1 = [FFDropDownMenuModel ff_DropDownMenuModelWithMenuItemTitle:activity menuItemIconName:StringFromSharedData(str_sorryTitle) menuBlock:^{
        ...
        if (_creatTeam.integerValue != 0) {
            ...
            [SVProgressHUD aboveBroadcast:[MaxInformation off:StringFromSharedData(str_dataSpitTitle)]];
        //: }else{
        }else{
            //: [self creatTeamGroup];
            [self elevenGroup];//创建群组
        }
    //: }];
    }];
    ...
    FFDropDownMenuModel *menuModel3 = [FFDropDownMenuModel ff_DropDownMenuModelWithMenuItemTitle:[MaxInformation off:StringFromSharedData(str_lifeData)] menuItemIconName:StringFromSharedData(str_sizeNeedTitle) menuBlock:^{
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        }
        ...
        UIAlertController *alertControl = [UIAlertController alertControllerWithTitle:[MaxInformation off:StringFromSharedData(str_gelTitle)] message:[MaxInformation off:StringFromSharedData(str_interventionRecordTitle)] preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[MaxInformation off:StringFromSharedData(str_tingData)] style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        //: }])];
        }])];
        ...
        [alertControl addAction:([UIAlertAction actionWithTitle:[MaxInformation off:StringFromSharedData(str_improvementValue)] style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            //: NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            NSURL *url = [[NSURL alloc] initWithString:UIApplicationOpenSettingsURLString];
            //: if( [[UIApplication sharedApplication] canOpenURL:url]) {
            if( [[UIApplication sharedApplication] canOpenURL:url]) {
...
-(void)elevenGroup{
    ...
    [self existingUponSearchor:^(NSArray *uids, NSString *name, UIImage *avater) {
        @
         //: try{} @finally{} __typeof__(self) self = __weak_self__;
         try{} @finally{} __typeof__(self) self = __weak_self__;
                        ;
...
//        [SVProgressHUD show];
        ...
        [self tap:avater close:^(NSString *urlString) {
            ...
            option.postscript = [MaxInformation off:StringFromSharedData(str_chickenData)];
//            [SVProgressHUD show];
...
//                [SVProgressHUD dismiss];
                ...
                if (!error) {
                    ...
                    [self fileAllocationTable:teamId replyType:option.name data:@"1"];
                    //: [self newGroupSyncRequest:option.name teamID:teamId];
                    [self add:option.name enable:teamId];
                //: }else{
                }else{
                    ...
                    [self.view makeToast:[MaxInformation off:StringFromSharedData(str_commissionName)] duration:2.0 position:CSToastPositionCenter];
                }
            //: }];
            }];
...
- (void)tap:(UIImage *)image close:(void(^)(NSString *urlString ))complete {
    ...
    UIImage *imageForAvatarUpload = [image scaling:CGSizeMake(375, 375)];
    //: NSString *fileName = [AAAKitFileLocationHelper genFilenameWithExt:@"jpg"];
    NSString *fileName = [FrankHelper of:StringFromSharedData(str_weaponName)];
    //: NSString *filePath = [[AAAKitFileLocationHelper getAppDocumentPath] stringByAppendingPathComponent:fileName];
    NSString *filePath = [[FrankHelper view] stringByAppendingPathComponent:fileName];
    ...
    if (success) {
        ...
        //: } completion:^(NSString * _Nullable urlString, NSError * _Nullable error) {
            ...
            //: }else{
                ...
                [wself.view makeToast:[MaxInformation off:StringFromSharedData(str_curiousData)]
                             //: duration:2
                             duration:2
    ...
    //: }else{
        ...
        [self.view makeToast:[MaxInformation off:StringFromSharedData(str_curiousData)]
                    //: duration:2
                    duration:2
                    //: position:CSToastPositionCenter];
                    position:CSToastPositionCenter];
...
-(void)add:(NSString *)groupName enable:(NSString *)teamId{
    //: NSMutableDictionary *dict = @{}.mutableCopy;
    NSMutableDictionary *dict = @{}.mutableCopy;
    //: dict[@"name"] = groupName;
    dict[StringFromSharedData(str_orationData)] = groupName;
    //: dict[@"id"] = teamId;
    dict[@"id"] = teamId;
    //: [ZCHttpManager getWithUrl:[NSString stringWithFormat:@"/team/create"] params:dict isShow:NO success:^(id responseObject) {
    [FromMessage maxColor:[NSString stringWithFormat:StringFromSharedData(str_listenSuraValue)] flush:dict countIn:NO alongResponseSuccess:^(id responseObject) {
...
- (RestoreView *)policyView
{
    ...
    if(!_policyView){
        ...
        _policyView = [[RestoreView alloc]initWithFrame:CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height)];
...
Byte * SharedDataToCache(Byte *data) {
    ...
    int active = data[1];
    Byte earwig = data[2];
    int namePasta = data[3];
    if (!idiom) return data + namePasta;
    for (int i = namePasta; i < namePasta + active; i++) {
        int value = data[i] - earwig;
        if (value < 0) {
            value += 256;
        }
        data[i] = value;
    ...
    data[0] = 0;
    data[namePasta + active] = 0;
    return data + namePasta;
}
