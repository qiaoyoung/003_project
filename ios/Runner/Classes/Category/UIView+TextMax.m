...
NSString * const k_firstTitle = @"kAlertViewUserInfo";



//: @implementation UIView (KIAdditions)
@implementation UIView (TextMax)
...
- (void)setUserInfo:(id)userInfo {
    ...
    objc_setAssociatedObject(self, (__bridge const void *)(k_firstTitle), userInfo, OBJC_ASSOCIATION_ASSIGN);
}

//: - (id)userInfo {
- (id)userInfo {
    //: return objc_getAssociatedObject(self, (__bridge const void *)(kViewUserInfo));
    return objc_getAssociatedObject(self, (__bridge const void *)(k_firstTitle));
}
...
- (void)name {
    ...
    endEditingTapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self
                                                                   ...
                                                                   action:@selector(mudraToCutCulminateDisable:)];
...
- (void)mudraToCutCulminateDisable:(UITapGestureRecognizer *)sender {
...
- (UIViewController *)scratch {
    ...
    return (UIViewController *)[self voice:self];
}
...
- (UIView *)withClass:(Class)superViewClass{
    ...
    if (![superView isKindOfClass:superViewClass]) {
        ...
        superView = [superView withClass:superViewClass];
    }
