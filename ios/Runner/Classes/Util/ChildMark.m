...
typedef struct {
    Byte limp;
    Byte *customDepressed;
    unsigned int puppySession;
    bool plainBuck;
	int statusImage;
	int anglicism;
} SquanderData;

NSString *StringFromSquanderData(SquanderData *data);


//: logged_another_device
SquanderData str_duringModelData = (SquanderData){212, (Byte []){184, 187, 179, 179, 177, 176, 139, 181, 186, 187, 160, 188, 177, 166, 139, 176, 177, 162, 189, 183, 177, 213}, 21, false, 37, 227};


//: Sunday
SquanderData str_readilyCuriousDuringValue = (SquanderData){145, (Byte []){194, 228, 255, 245, 240, 232, 220}, 6, false, 171, 103};


//: before_yesterday
SquanderData str_joinTuckName = (SquanderData){75, (Byte []){41, 46, 45, 36, 57, 46, 20, 50, 46, 56, 63, 46, 57, 47, 42, 50, 137}, 16, false, 27, 96};


//: group_member_info_activity_team_admin
SquanderData str_analValue = (SquanderData){4, (Byte []){99, 118, 107, 113, 116, 91, 105, 97, 105, 102, 97, 118, 91, 109, 106, 98, 107, 91, 101, 103, 112, 109, 114, 109, 112, 125, 91, 112, 97, 101, 105, 91, 101, 96, 105, 109, 106, 109}, 37, false, 11, 176};


//: Wednesday
SquanderData str_magnetName = (SquanderData){1, (Byte []){86, 100, 101, 111, 100, 114, 101, 96, 120, 132}, 9, false, 30, 37};


//: day_night
SquanderData str_electricalDrivingBareName = (SquanderData){8, (Byte []){108, 105, 113, 87, 102, 97, 111, 96, 124, 178}, 9, false, 63, 7};


//: please_try_again
SquanderData str_ehGoingData = (SquanderData){34, (Byte []){82, 78, 71, 67, 81, 71, 125, 86, 80, 91, 125, 67, 69, 67, 75, 76, 47}, 16, false, 109, 79};


//: online_state_event_manager_off_line
SquanderData str_ratedName = (SquanderData){83, (Byte []){60, 61, 63, 58, 61, 54, 12, 32, 39, 50, 39, 54, 12, 54, 37, 54, 61, 39, 12, 62, 50, 61, 50, 52, 54, 33, 12, 60, 53, 53, 12, 63, 58, 61, 54, 168}, 35, false, 177, 98};


//: Friday
SquanderData str_significanceValue = (SquanderData){162, (Byte []){228, 208, 203, 198, 195, 219, 8}, 6, false, 115, 55};


//: %zd-%zd-%zd
SquanderData str_duringText = (SquanderData){154, (Byte []){191, 224, 254, 183, 191, 224, 254, 183, 191, 224, 254, 247}, 11, false, 105, 130};


//: wrong_password
SquanderData str_onlyOrationData = (SquanderData){79, (Byte []){56, 61, 32, 33, 40, 16, 63, 46, 60, 60, 56, 32, 61, 43, 138}, 14, false, 46, 228};


//: wee_hours
SquanderData str_sessionAmbleData = (SquanderData){108, (Byte []){27, 9, 9, 51, 4, 3, 25, 30, 31, 164}, 9, false, 251, 185};


//: Mac
SquanderData str_appreciateName = (SquanderData){14, (Byte []){67, 111, 109, 201}, 3, false, 119, 69};


//: day_am
SquanderData str_linkAnalCombineValue = (SquanderData){239, (Byte []){139, 142, 150, 176, 142, 130, 226}, 6, false, 208, 117};


//: Android
SquanderData str_naturalIndexData = (SquanderData){154, (Byte []){219, 244, 254, 232, 245, 243, 254, 205}, 7, false, 21, 124};


//: Monday
SquanderData str_potName = (SquanderData){73, (Byte []){4, 38, 39, 45, 40, 48, 11}, 6, false, 56, 90};


//: message_helper_you
SquanderData str_awarenessData = (SquanderData){190, (Byte []){211, 219, 205, 205, 223, 217, 219, 225, 214, 219, 210, 206, 219, 204, 225, 199, 209, 203, 224}, 18, false, 64, 180};


//: retracted_message
SquanderData str_entireText = (SquanderData){237, (Byte []){159, 136, 153, 159, 140, 142, 153, 136, 137, 178, 128, 136, 158, 158, 140, 138, 136, 100}, 17, false, 22, 131};


//: Web
SquanderData str_liabilityText = (SquanderData){88, (Byte []){15, 61, 58, 52}, 3, false, 140, 160};


//: Saturday
SquanderData str_estheticData = (SquanderData){86, (Byte []){5, 55, 34, 35, 36, 50, 55, 47, 247}, 8, false, 31, 159};


//: group_member_info_activity_team_creator
SquanderData str_enterpriseBottomDateContent = (SquanderData){118, (Byte []){17, 4, 25, 3, 6, 41, 27, 19, 27, 20, 19, 4, 41, 31, 24, 16, 25, 41, 23, 21, 2, 31, 0, 31, 2, 15, 41, 2, 19, 23, 27, 41, 21, 4, 19, 23, 2, 25, 4, 167}, 39, false, 176, 197};


//: iOS
SquanderData str_flavorBlackValue = (SquanderData){182, (Byte []){223, 249, 229, 200}, 3, false, 244, 68};


//: login_failure
SquanderData str_basketballName = (SquanderData){28, (Byte []){112, 115, 123, 117, 114, 67, 122, 125, 117, 112, 105, 110, 121, 86}, 13, false, 70, 75};


//: Tuesday
SquanderData str_troubledTitle = (SquanderData){40, (Byte []){124, 93, 77, 91, 76, 73, 81, 140}, 7, false, 181, 38};


//: message_opposite
SquanderData str_positTitle = (SquanderData){162, (Byte []){207, 199, 209, 209, 195, 197, 199, 253, 205, 210, 210, 205, 209, 203, 214, 199, 96}, 16, false, 232, 80};


//: postscript
SquanderData str_hesitateData = (SquanderData){242, (Byte []){130, 157, 129, 134, 129, 145, 128, 155, 130, 134, 184}, 10, false, 186, 138};


//: day_pm
SquanderData str_scapeContent = (SquanderData){98, (Byte []){6, 3, 27, 61, 18, 15, 249}, 6, false, 225, 236};


//: message_online
SquanderData str_labWipeTitle = (SquanderData){110, (Byte []){3, 11, 29, 29, 15, 9, 11, 49, 1, 0, 2, 7, 0, 11, 28}, 14, false, 149, 69};


//: online_state_event_manager_on_line_busy
SquanderData str_battleName = (SquanderData){237, (Byte []){130, 131, 129, 132, 131, 136, 178, 158, 153, 140, 153, 136, 178, 136, 155, 136, 131, 153, 178, 128, 140, 131, 140, 138, 136, 159, 178, 130, 131, 178, 129, 132, 131, 136, 178, 143, 152, 158, 148, 200}, 39, false, 83, 120};


//: yesterday
SquanderData str_dateText = (SquanderData){28, (Byte []){101, 121, 111, 104, 121, 110, 120, 125, 101, 72}, 9, false, 212, 229};


//: Thursday
SquanderData str_bandValue = (SquanderData){54, (Byte []){98, 94, 67, 68, 69, 82, 87, 79, 10}, 8, false, 57, 133};
...
double k_deviceText = 24*60*60; //一天的秒数

//: static NSString *const NTESRecentSessionAtMark = @"NTESRecentSessionAtMark";
static NSString *const k_currentData = @"NTESRecentSessionAtMark";
//: static NSString *const NTESRecentSessionTopMark = @"NTESRecentSessionTopMark";
static NSString *const k_managerData = @"NTESRecentSessionTopMark";


//: @implementation NTESSessionUtil
@implementation ChildMark
...
+(BOOL)display:(NSTimeInterval)currentTime worldView:(NSDateComponents*)older
{
...
+(NSString*)table:(NSInteger)dayOfWeek
{
    //: static NSDictionary *daysOfWeekDict = nil;
    static NSDictionary *daysOfWeekDict = nil;
    //: daysOfWeekDict = @{@(1):[NTESLanguageManager getTextWithKey:@"Sunday"],//@"星期日".ntes_localized,
    daysOfWeekDict = @{@(1):[MaxInformation off:StringFromSquanderData(&str_readilyCuriousDuringValue)],//@"星期日".ntes_localized,
                       //: @(2):[NTESLanguageManager getTextWithKey:@"Monday"],//@"星期一".ntes_localized,
                       @(2):[MaxInformation off:StringFromSquanderData(&str_potName)],//@"星期一".ntes_localized,
                       //: @(3):[NTESLanguageManager getTextWithKey:@"Tuesday"],//@"星期二".ntes_localized,
                       @(3):[MaxInformation off:StringFromSquanderData(&str_troubledTitle)],//@"星期二".ntes_localized,
                       //: @(4):[NTESLanguageManager getTextWithKey:@"Wednesday"],//@"星期三".ntes_localized,
                       @(4):[MaxInformation off:StringFromSquanderData(&str_magnetName)],//@"星期三".ntes_localized,
                       //: @(5):[NTESLanguageManager getTextWithKey:@"Thursday"],//@"星期四".ntes_localized,
                       @(5):[MaxInformation off:StringFromSquanderData(&str_bandValue)],//@"星期四".ntes_localized,
                       //: @(6):[NTESLanguageManager getTextWithKey:@"Friday"],//@"星期五".ntes_localized,
                       @(6):[MaxInformation off:StringFromSquanderData(&str_significanceValue)],//@"星期五".ntes_localized,
                       //: @(7):[NTESLanguageManager getTextWithKey:@"Saturday"]};
                       @(7):[MaxInformation off:StringFromSquanderData(&str_estheticData)]};//@"星期六".ntes_localized,};
...
+(NSDateComponents*)snapline:(NSTimeInterval)messageTime tag:(NSCalendarUnit)components
{
...
+(NSString*)detail:(NSTimeInterval) msglastTime file:(BOOL)showDetail
{
    ...
    result = [ChildMark monthMinute:hour fullMoonMinute:msgDateComponents.minute];
    //: if (hour > 12)
    if (hour > 12)
    {
        //: hour = hour - 12;
    ...
    else if(nowDateComponents.day == (msgDateComponents.day+1))//昨天
    {
        ...
        result = showDetail? [[NSString alloc] initWithFormat:@"%@%@ %zd:%02d",[MaxInformation off:StringFromSquanderData(&str_dateText)], result,hour,(int)msgDateComponents.minute] : [MaxInformation off:StringFromSquanderData(&str_dateText)];//昨天
    }
    ...
    else if(nowDateComponents.day == (msgDateComponents.day+2)) //前天
    {
        ...
        result = showDetail? [[NSString alloc] initWithFormat:@"%@%@ %zd:%02d",[MaxInformation off:StringFromSquanderData(&str_joinTuckName)], result,hour,(int)msgDateComponents.minute] : [MaxInformation off:StringFromSquanderData(&str_joinTuckName)];//@"前天".ntes_localized;
    }
    //: else if([nowDate timeIntervalSinceDate:msgDate] < 7 * OnedayTimeIntervalValue)
    else if([nowDate timeIntervalSinceDate:msgDate] < 7 * k_deviceText)//一周内
    {
        //: NSString *weekDay = [NTESSessionUtil weekdayStr:msgDateComponents.weekday];
        NSString *weekDay = [ChildMark table:msgDateComponents.weekday];
    ...
    else//显示日期
    {
        ...
        NSString *day = [NSString stringWithFormat:StringFromSquanderData(&str_duringText), msgDateComponents.year, msgDateComponents.month, msgDateComponents.day];
...
+ (NSString *)monthMinute:(NSInteger)time fullMoonMinute:(NSInteger)minute
{
    ...
    if (totalMin > 0 && totalMin <= 5 * 60)
    {
        ...
        showPeriodOfTime = [MaxInformation off:StringFromSquanderData(&str_sessionAmbleData)];//@"凌晨".ntes_localized;
    }
    //: else if (totalMin > 5 * 60 && totalMin < 12 * 60)
    else if (totalMin > 5 * 60 && totalMin < 12 * 60)
    {
        //: showPeriodOfTime = [NTESLanguageManager getTextWithKey:@"day_am"];
        showPeriodOfTime = [MaxInformation off:StringFromSquanderData(&str_linkAnalCombineValue)];//@"上午".ntes_localized;
    }
    //: else if (totalMin >= 12 * 60 && totalMin <= 18 * 60)
    else if (totalMin >= 12 * 60 && totalMin <= 18 * 60)
    {
        //: showPeriodOfTime = [NTESLanguageManager getTextWithKey:@"day_pm"];
        showPeriodOfTime = [MaxInformation off:StringFromSquanderData(&str_scapeContent)];//@"下午".ntes_localized;
    }
    //: else if ((totalMin > 18 * 60 && totalMin <= (23 * 60 + 59)) || totalMin == 0)
    else if ((totalMin > 18 * 60 && totalMin <= (23 * 60 + 59)) || totalMin == 0)
    {
        //: showPeriodOfTime = [NTESLanguageManager getTextWithKey:@"day_night"];
        showPeriodOfTime = [MaxInformation off:StringFromSquanderData(&str_electricalDrivingBareName)];//@"晚上".ntes_localized;
    }
...
+ (NSString *)roundBy:(NSString *)postscript {
    ...
    NSString *tip = [MaxInformation off:StringFromSquanderData(&str_awarenessData)];//@"你".ntes_localized;
    //: NSString *msg = [NSString stringWithFormat:@"%@%@", tip,[NTESLanguageManager getTextWithKey:@"retracted_message"]];
    NSString *msg = [NSString stringWithFormat:@"%@%@", tip,[MaxInformation off:StringFromSquanderData(&str_entireText)]];
    ...
    if (postscript.length != 0) {
        ...
        msg = [NSString stringWithFormat:@"%@%@.%@:%@", tip,[MaxInformation off:StringFromSquanderData(&str_entireText)],[MaxInformation off:StringFromSquanderData(&str_hesitateData)], postscript];
    }
    //: return msg;
    return msg;
}
...
+ (NSString *)bubbleFileAllow:(NIMRevokeMessageNotification *)notification
{
    //: NSString *tip = @"";
    NSString *tip = @"";
    //: do {
    do {
        ...
        if (!notification || ![notification isKindOfClass:[NIMRevokeMessageNotification class]]) {
            ...
            tip = [MaxInformation off:StringFromSquanderData(&str_awarenessData)];//@"你".ntes_localized;
            //: break;
            break;
        }
    ...
    if (notification.postscript.length != 0) {
        ...
        msg = [NSString stringWithFormat:@"%@ %@.%@:%@", tip,[MaxInformation off:StringFromSquanderData(&str_entireText)],[MaxInformation off:StringFromSquanderData(&str_hesitateData)], notification.postscript];
    }
    //: return msg;
    return msg;
}
...
+ (NSString *)red:(NIMRevokeMessageNotification *)notification {
    ...
    return fromMe ? [MaxInformation off:StringFromSquanderData(&str_awarenessData)]: [MaxInformation off:StringFromSquanderData(&str_positTitle)];//@"对方".ntes_localized;
}

//: + (NSString *)tipTitleFromMessageRevokeNotificationTeam:(NIMRevokeMessageNotification *)notification {
+ (NSString *)imageTeam:(NIMRevokeMessageNotification *)notification {
    //: NSString *tipTitle = @"";
    NSString *tipTitle = @"";
    ...
    do {
        ...
        if (revokeBySender && fromMe) {
            ...
            tipTitle = [MaxInformation off:StringFromSquanderData(&str_awarenessData)];//@"你".ntes_localized;
            //: break;
            break;
        }
        ...
        option.session = session;
        //: CCCKitInfo *info = [[AppleProjectKit sharedKit] infoByUser:(revokeBySender ? fromUid : operatorUid) option:option];
        TitleInfo *info = [[Indicator reach] indoors:(revokeBySender ? fromUid : operatorUid) harvest:option];
        ...
        if (member.type == NIMTeamMemberTypeOwner) {
            ...
            tipTitle = [[MaxInformation off:StringFromSquanderData(&str_enterpriseBottomDateContent)] stringByAppendingString:info.showName];//@"群主".ntes_localized
        }
        //: else if (member.type == NIMTeamMemberTypeManager) {
            ...
            tipTitle = [[MaxInformation off:StringFromSquanderData(&str_analValue)] stringByAppendingString:info.showName];//@"管理员".ntes_localized
        }
    //: } while (false);
    } while (false);
...
+ (BOOL)change:(NIMMessage *)message
{
    ...
    if ([messageObject isKindOfClass:[NIMCustomObject class]])
    {
        ...
        id<TingChild> attach = (id<TingChild>)[(NIMCustomObject *)message.messageObject attachment];
...
+ (BOOL)itemTo:(NIMMessage *)message
{
    ...
    BOOL canRevokeMessageByRole = [self canvas:message];
...
+ (BOOL)canvas:(NIMMessage *)message
{
...
+ (void)magnitudeWith:(NIMSession *)session device:(NTESRecentSessionMarkType)type
{
    ...
    if (recent)
    {
        ...
        NSString *key = [ChildMark text:type];
...
+ (NSString *)text:(NTESRecentSessionMarkType)type
{
    ...
    _dispatch_once(&onceToken, ^{
        ...
        keys = @{
                 ...
                 @(NTESRecentSessionMarkTypeAt) : k_currentData,
                 //: @(NTESRecentSessionMarkTypeTop) : NTESRecentSessionTopMark
                 @(NTESRecentSessionMarkTypeTop) : k_managerData
                 //: };
                 };
    //: });
    });
...
+ (NSString *)nameDetail:(NSString *)userId detail:(BOOL)detail
{
    ...
    if (![ShowManager error] || [[NIMSDK sharedSDK].loginManager.currentAccount isEqualToString:userId])
    {
    ...
    NSDictionary *dict = [[ShowManager error] unwelcome:NIMSubscribeSystemEventTypeOnline];
    ...
    if ([info isKindOfClass:[NIMSubscribeOnlineInfo class]] && info.senderClientTypes.count)
    {
        ...
        NIMLoginClientType client = [self inside:info.senderClientTypes];
        ...
        switch (event.value) {
            ...
            case NIMSubscribeEventOnlineValueDisconnected:
            {
                ...
                state = [self belowLawyerClientRelationOption:ext survival:client allow:detail];
            }
                //: break;
                break;
            ...
            default:
            {
                ...
                NSString *clientName = [self part:client];
                //: state = [NSString stringWithFormat:@"%@ %@", clientName, [NTESLanguageManager getTextWithKey:@"message_online"]];
                state = [NSString stringWithFormat:@"%@ %@", clientName, [MaxInformation off:StringFromSquanderData(&str_labWipeTitle)]];
                //: break;
                break;
            }
        }
...
+ (NIMLoginClientType)inside:(NSArray *)senderClientTypes
{
...
+ (NSString *)part:(NIMLoginClientType )client
{
    ...
    NSDictionary *formats = @{
                              ...
                              @(NIMLoginClientTypemacOS) : StringFromSquanderData(&str_appreciateName),
                              //: @(NIMLoginClientTypeiOS): @"iOS",
                              @(NIMLoginClientTypeiOS): StringFromSquanderData(&str_flavorBlackValue),
                              //: @(NIMLoginClientTypeAOS): @"Android",
                              @(NIMLoginClientTypeAOS): StringFromSquanderData(&str_naturalIndexData),
                              //: @(NIMLoginClientTypeWeb): @"Web",
                              @(NIMLoginClientTypeWeb): StringFromSquanderData(&str_liabilityText),
...
+ (NSString *)belowLawyerClientRelationOption:(NSString *)ext survival:(NIMLoginClientType)client allow:(BOOL)detail
{
    //: NSString *clientName = [self resolveOnlineClientName:client];
    NSString *clientName = [self part:client];
    //: NSString *state = [NSString stringWithFormat:@"%@ %@",clientName,[NTESLanguageManager getTextWithKey:@"message_online"]];
    NSString *state = [NSString stringWithFormat:@"%@ %@",clientName,[MaxInformation off:StringFromSquanderData(&str_labWipeTitle)]];//@"在线".ntes_localized
    //: NSDictionary *dict = [ext nimkit_jsonDict];
    NSDictionary *dict = [ext last];
    //: if (dict) {
    if (dict) {

        //: NSString *netState = [[NTESDevice currentDevice] networkStatus:[dict jsonInteger:NTESSubscribeNetState]];
        NSString *netState = [[StateDevice straddle] graduateIsland:[dict app:k_styleValue]];
        //: NTESOnlineState onlineState = [dict jsonInteger:NTESSubscribeOnlineState];
        NTESOnlineState onlineState = [dict app:k_formatValue];
        //: switch (onlineState) {
        switch (onlineState) {
            ...
            case NTESOnlineStateNormal:
            {
                    ...
                    client == NIMLoginClientTypemacOS)
                {
                    ...
                    return [NSString stringWithFormat:@"%@ %@",clientName,[MaxInformation off:StringFromSquanderData(&str_labWipeTitle)]];//@"在线".ntes_localized
                }
                //: else
                else
                {
                    ...
                    if (detail)
                    {
                        ...
                        return [NSString stringWithFormat:@"%@ - %@ %@",clientName,netState,[MaxInformation off:StringFromSquanderData(&str_labWipeTitle)]];//@"在线".ntes_localized
                    }
                    //: else
                    else
                    {
                        //: return [NSString stringWithFormat:@"%@ %@",netState,[NTESLanguageManager getTextWithKey:@"message_online"]];
                        return [NSString stringWithFormat:@"%@ %@",netState,[MaxInformation off:StringFromSquanderData(&str_labWipeTitle)]];//@"在线".ntes_localized
                    }
                }
            }
            ...
            case NTESOnlineStateBusy:
                ...
                return [MaxInformation off:StringFromSquanderData(&str_battleName)];//@"忙碌".ntes_localized;
            //: case NTESOnlineStateLeave:
            case NTESOnlineStateLeave:
                //: return [NTESLanguageManager getTextWithKey:@"online_state_event_manager_off_line"];
                return [MaxInformation off:StringFromSquanderData(&str_ratedName)];//@"离开".ntes_localized;
            //: default:
            default:
                //: break;
                break;
...
+ (NSString *)opticSurfaceSpace:(NSError *)error
{
    ...
    NSString *message = [NSString stringWithFormat:@"%@ %@",[MaxInformation off:StringFromSquanderData(&str_basketballName)], error];//,@"自动登录失败".ntes_localized
    ...
    if ([domain isEqualToString:NIMLocalErrorDomain])
    {
        ...
        if (code == NIMLocalErrorCodeAutoLoginRetryLimit)
        {
            ...
            message = [MaxInformation off:StringFromSquanderData(&str_ehGoingData)];//@"自动登录错误次数超限，请检查网络后重试".ntes_localized;
        }
    }
    ...
    else if([domain isEqualToString:NIMRemoteErrorDomain])
    {
        ...
        if (code == NIMRemoteErrorCodeInvalidPass)
        {
            ...
            message = [MaxInformation off:StringFromSquanderData(&str_onlyOrationData)];//@"密码错误".ntes_localized;
        }
        //: else if(code == NIMRemoteErrorCodeExist)
        else if(code == NIMRemoteErrorCodeExist)
        {
            //: message = [NTESLanguageManager getTextWithKey:@"logged_another_device"];
            message = [MaxInformation off:StringFromSquanderData(&str_duringModelData)];//@"当前已经其他设备登录，请使用手动模式登录".ntes_localized;
        }
    }
    //: return message;
    return message;
...
Byte *SquanderDataToByte(SquanderData *data) {
    if (data->plainBuck) return data->customDepressed;
    for (int i = 0; i < data->puppySession; i++) {
        data->customDepressed[i] ^= data->limp;
    }
    data->customDepressed[data->puppySession] = 0;
    data->plainBuck = true;
	if (data->puppySession >= 2) {
		data->statusImage = data->customDepressed[0];
		data->anglicism = data->customDepressed[1];
	}
    return data->customDepressed;
}

NSString *StringFromSquanderData(SquanderData *data) {
    return [NSString stringWithUTF8String:(char *)SquanderDataToByte(data)];
}
